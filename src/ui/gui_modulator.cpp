...
void gui_modulator_main_window(App *app)
{
    ...
    
    {
        ...
        ImGui::ColorEdit3("clear color", (float*)&gui->imgui->bgColor); // Edit 3 floats representing a color
    ...
    {
        ImGui::Begin("Another Window", &gui->show_about_window);   // Pass a pointer to our bool variable (the window will have a closing button that will clear the bool when clicked)
